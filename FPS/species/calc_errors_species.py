...
u_al    = ase.io.read("unsorted.FPS-875803.abcd_all_gen47_20210610-161321.xyz", index=":")
species = "C"

indexes = [0]
for a in u_al:
    n_atoms = len([atom for atom in a if atom.symbol == species])
    indexes.append(indexes[-1] + n_atoms)
...
desc_data = np.load("C-ONLY.SOAP_l4-n8-s0.5-c3.5-ctw-0.5-cw-1_unsorted.FPS-875803.abcd_all_gen47_20210610-161321.npy")
data      = desc_data.T
print(data.shape)
